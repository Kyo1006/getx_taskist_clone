...
class TaskList extends StatelessWidget {
  ...
  void navigateCreateList(BuildContext context) {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => const CreateList()));
  }

  Padding addListButton(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        ...
        child: OutlinedButton(
            ...
            onPressed: () => navigateCreateList(context),
